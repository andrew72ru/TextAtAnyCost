...
class Rtf implements ConverterInterface, ReadFileInterface
{
    /**
     * @var string
     */
    ...
    protected function fromMacRoman($c): string
    {
        $table = [
