...
class DocxAndOdt
{
    ...
    {
        return $this->getTextFromZippedXML($filename, 'content.xml');
    }

    public function docx2text($filename)
    {
        return $this->getTextFromZippedXML($filename, 'word/document.xml');
    }

    protected function getTextFromZippedXML($archiveFile, $contentFile)
    {
